;; This model extends idea of Stuart Kaufman one step further:
;; Not even that cell reacts differently to states of two connected cells,
;; but they reacts to them accordnig states of another 4 cells,
;; i.e. these another 4 cells tell the updating cell,
;; how to react to the states of 2 connected cells.
;;
